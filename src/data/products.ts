const products = [
  {
    title: 'Enkei Racing RS05RR', image: 'ENKEI-RS05RR-GM-190-WEB.png', colors: ['gray', 'silver'], details: [
  ...
  // },
  {
    title: 'APEX ARC-8', image: '18-arc8-5120-smbk-profile1_3.png', colors: ['gray', 'silver', 'black'], details: [
  ...
  {
    title: 'O.Z. Racing Hyper GT HLT', image: '02_HyperGT-hlt-Star-Graphite-jpg-100x750-2.png', colors: ['gray', 'black'], details: [
      // { size: 18, width: 7.5, inset: 35, price: 285 },
      { size: 18, width: 8, inset: 45, price: 385 },
    ]
  },
  {
    title: 'KONIG Rennform', image: 'kon-rennform-grey.png', colors: ['gray'], details: [
  ...
  {
    title: 'TSW Neptune', image: 'alloy-wheels-rims-tsw-neptune-5-lug-semi-gloss-black-std-700.jpg', colors: ['black', 'gray', 'bronze'], details: [
